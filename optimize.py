...
def create_model(trial):
  ...
  model.add(tf.keras.layers.Conv2D(filters=16, kernel_size= kz_selected, padding='same', activation='relu', name='conv2D_2'))
  model.add(tf.keras.layers.AveragePooling2D(pool_size=(2,2),padding='same', name='AvP_1'))

  model.add(tf.keras.layers.Conv2D(filters=32, kernel_size= kz_selected, padding='same', activation='relu', name='conv2D_3'))
  model.add(tf.keras.layers.Conv2D(filters=32, kernel_size= kz_selected, padding='same', activation='relu', name='conv2D_4'))
  model.add(tf.keras.layers.AveragePooling2D(pool_size=(2,2),padding='same', name='AvP_2'))

  model.add(tf.keras.layers.Conv2DTranspose(filters=32, kernel_size= kz_selected, padding='same', activation='relu', name='conv2DT_1'))
  model.add(tf.keras.layers.Conv2DTranspose(filters=32, kernel_size= kz_selected, padding='same', activation='relu', name='conv2DT_2'))
  ...
  model.add(tf.keras.layers.Conv2DTranspose(filters=16, kernel_size= kz_selected, padding='same', activation='relu', name='conv2DT_3'))
  ...
  model.add(tf.keras.layers.Conv2DTranspose(filters=1, kernel_size= kz_selected, padding='same', activation='linear', name='output')) #output
  return model
