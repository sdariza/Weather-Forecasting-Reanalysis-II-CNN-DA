...
nc_data = nc.Dataset('./nc-files/vwnd/vwnd.2020.nc')
...
cbar.set_label(nc_data.variables['vwnd'].units)
plt.show()

print(nc_data['vwnd'][:][:,0,...].data.shape)
